...
// If no injected web3 instance is detected, fall back to Ganache
            ...
            App.web3Provider = new Web3.providers.HttpProvider('http://127.0.0.0:8545');
        }
    ...
    castVote:  async function () {
        ...
        App.contracts.Election.deployed().then(function (instance) {
            ...
            location.href='success_vote.html';
        }).catch(function (err) {
            console.error(err);
        });  
        
        
       /* const reqBody = { "account_id": App.account, "used_vote" : "yes"};
        const response = await fetch('https://prod-35.eastus.logic.azure.com:443/workflows/45826476803149f999b13b63637cbab8/triggers/manual/paths/invoke?api-version=2016-10-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=qpwbGYgrin2kV7KG8k2vx0nnZy4WM4Eo7MgEUgzh-FI', {
            method: 'POST',
    ...
    addUser: async function () {
        ...
        var accountId = App.account;
       
        /* const reqBody = { "first_name": firstName, "last_name" : lastName, "id_number": idNumber, "email" : email , "password" : password , "account_id" : accountId};
        const response = await fetch('https://prod-69.eastus.logic.azure.com:443/workflows/9e13c80ce9524a9eb5823dab42da163e/triggers/manual/paths/invoke?api-version=2016-10-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=sCD230wL3Ww5xIb4xIj3-akATvrpa0HoRSbA2J8T2w8', {
            method: 'POST',
            body: JSON.stringify(reqBody) , // string or object
            headers: {
              'Content-Type': 'application/json'
    ...
    addCandidate: async function (){
       ...
       /* const reqBody = { "first_name": CfirstName, "last_name" : ClastName, "cid_number": CidNumber};
        const response = await fetch('https://prod-07.eastus.logic.azure.com:443/workflows/57f2eab667e04b6b8b9a7e4f39137c56/triggers/manual/paths/invoke?api-version=2016-10-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=pOTmTcX9W9nph0WVQilHEDWSrkZ-b5TJ-DpZWYBcoLA', {
            method: 'POST',
            body: JSON.stringify(reqBody) , // string or object
            headers: {
              'Content-Type': 'application/json'
